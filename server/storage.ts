    ...
    const sampleProjects: InsertProject[] = [
      {
        ...
        seoTitle: "Exterior Building Services | Waterproofing & Restoration | Shall's Construction",
        seoDescription: "Comprehensive exterior building maintenance and waterproofing services in Maryland, DC, and Virginia. Protect your property with expert facade repair and restoration.",
        tagline: "Protecting and Restoring Your Building's Exterior",
        philosophy: "Your building's exterior is its first line of defense. Since 1992, Shall's Construction has specialized in waterproofing, restoration, and facade maintenance for commercial, industrial, and institutional properties throughout the DC Metro region. Our mission is simple: extend the life of your structure and prevent costly damage before it occurs.\n\nWe pair technical expertise with a hands-on, detail-driven approach. Our waterproofing crews and skilled masons understand the full spectrum of building envelope systems — from masonry joints to flashing and coatings. Every project is carefully planned to limit tenant disruption and executed by our experienced in-house staff licensed in MD, VA, DC, and DE.\n\nWhether you're addressing water intrusion, repairing cracked masonry, or performing preventive sealant replacement, our team ensures long-term reliability. We also offer 24/7 emergency exterior repair response when issues demand immediate attention.",
        servicesInclude: [
          "Waterproofing, caulking, and sealing",
          "Masonry restoration and repointing",
          "Joint-sealant replacement",
          "Concrete and lintel repair",
          "Power washing and facade cleaning",
          "Leak investigation and repair",
          "Garage waterproofing and coatings"
        ],
      ...
      },
      {
        ...
        title: "Parking Lot Services",
        shortDescription: "Professional parking lot maintenance with attention to detail and operational efficiency for commercial properties.",
        fullDescription: "At Shall's Construction, we understand that parking lot maintenance requires precision, proper equipment, and minimal disruption to your business operations. For over 30 years, commercial property managers have trusted us for comprehensive parking lot services.",
        benefits: [
        ...
        icon: "Car",
        featured: true,
        seoTitle: "Parking Lot Maintenance & Paving | Shall's Construction | MD, VA, DC",
        seoDescription: "Asphalt paving, concrete repair, striping, and sealcoating for commercial properties. Shall's Construction delivers long-lasting parking lot solutions with minimal disruption.",
        tagline: "Professional Parking Lot Maintenance and Restoration",
        philosophy: "A well-maintained parking lot sets the tone for your property. Shall's Construction provides commercial property managers with full-service asphalt and concrete solutions designed for durability, safety, and aesthetic appeal. For over 30 years, we've handled everything from patching to complete resurfacing throughout Montgomery County, Bethesda, and Kensington.\n\nOur 95% in-house operations ensure consistent workmanship, tight quality control, and timely scheduling. We handle every detail — grading, drainage, curbs, striping, and ADA compliance — using industry-grade materials and specialized equipment. Work is performed during off-hours when necessary to keep your property accessible.\n\nWhether your lot needs a full mill-and-overlay or preventive sealcoating, we tailor solutions to your property's traffic patterns and budget. Our reputation for reliability, safety, and responsiveness has made us a go-to contractor for retail, healthcare, education, and government facilities.",
        servicesInclude: [
          "Asphalt paving, repair, and resurfacing",
          ...
          "Drainage and storm inlet repairs",
          "Speed bump and bollard installation",
          "24/7 emergency lot repair"
        ],
        testimonialQuote: null,
        testimonialAuthor: null,
        testimonialRole: null,
      ...
      },
      {
        ...
        fullDescription: "Professional commercial painting does more than refresh your building's appearance—it adds long-term value and protects your property investment. Shall's Construction brings over 30 years of specialized experience in interior and exterior commercial painting.",
        benefits: [
        ...
        featured: true,
        seoTitle: "Commercial Painting Services | Interior & Exterior | Shall's Construction",
        seoDescription: "Expert interior and exterior painting services for commercial buildings in Maryland and DC. Enhance appearance and protection with Shall's Construction.",
        tagline: "Precision Painting for Commercial Interiors and Exteriors",
        philosophy: "A professional paint job does more than refresh a property — it protects it. Shall's Construction offers full-spectrum commercial painting services that combine craftsmanship, design guidance, and efficiency. We deliver long-lasting finishes for office buildings, retail centers, schools, and healthcare facilities throughout the DC Metro area.\n\nOur in-house team handles every stage — surface prep, priming, application, and clean-up — ensuring consistency and minimal disruption to tenants. We use premium materials and proven methods suited for each surface type, whether drywall, masonry, or metal.\n\nProjects are scheduled strategically to maintain business continuity, and our professionals can advise on color palettes, coatings, and finishes that enhance brand image while improving durability.",
        servicesInclude: [
          "Interior and exterior commercial painting",
          "Surface preparation and drywall finishing",
          "Epoxy and specialty coatings",
          "Wall covering installation and removal",
          "Wood treatment and staining",
          "Parking garage sealing and painting",
          "Common area and lobby refreshes"
        ],
        testimonialQuote: null,
        testimonialAuthor: null,
        testimonialRole: null,
      ...
      },
      {
        ...
        fullDescription: "Winter weather doesn't wait for convenient timing, and neither do property managers who need reliable snow and ice management. Shall's Construction has provided professional snow removal services for over 30 years.",
        benefits: [
        ...
        icon: "Snowflake",
        featured: true,
        seoTitle: "Snow & Ice Removal Services | Shall's Construction | Montgomery County, MD",
        seoDescription: "Reliable snow and ice management for commercial properties across Montgomery County, Bethesda, and Kensington. 24/7/365 emergency response by Shall's Construction.",
        tagline: "Dependable Snow & Ice Management for Commercial Properties",
        philosophy: "Winter doesn't pause your business — neither do we. Shall's Construction provides proactive, full-service snow removal and ice management for commercial and institutional properties throughout Montgomery County, Bethesda, and Kensington. Our crews are on standby before storms hit, keeping your property safe, compliant, and accessible.\n\nWe maintain our own fleet of plows, loaders, and de-icing equipment operated by our experienced in-house team. With decades of regional experience, we know how to plan, monitor, and execute efficient snow clearing — even in the toughest conditions.\n\nOur approach is strategic: pre-storm salting, prioritized plow routes, and off-hour scheduling that ensures tenants and visitors can safely access your property. We operate around the clock throughout the winter season and respond immediately to weather alerts.",
        servicesInclude: [
          "Parking lot plowing and hauling",
          "Sidewalk and walkway clearing",
          "Ice control and preventive de-icing",
          "Pre-storm planning and salt application",
